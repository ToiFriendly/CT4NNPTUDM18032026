...
module.exports = {
  ...
  CreateAnUserValidator: [
    ...
    body("password")
      ...
      .withMessage(
        "password phai co it nhat 8 ki tu trong do co it nhat: 1 ki tu hoa, 1 ki tu thuong, 1 ki tu dac biet va 1 ki tu so",
      ),
    body("role")
      .notEmpty()
  ...
  ChangePasswordValidator: [
    ...
    body("newpassword")
      ...
      .withMessage(
        "newpassword phai co it nhat 8 ki tu trong do co it nhat: 1 ki tu hoa, 1 ki tu thuong, 1 ki tu dac biet va 1 ki tu so",
      ),
  ],
